...
export class ColorSettingsModel 
{
    constructor(
        ...
        static fromObject(data: Partial<ColorSettingsModel>): ColorSettingsModel {
    return new ColorSettingsModel(
        GradientArgbColorModel.fromObject(data.confirmGradientButton!),
        GradientArgbColorModel.fromObject(data.confirmGradientButtonHover!),
        GradientArgbColorModel.fromObject(data.confirmGradientButtonDisabled!),
        GradientArgbColorModel.fromObject(data.deleteGradientButton!),
        GradientArgbColorModel.fromObject(data.deleteGradientButtonHover!),
        GradientArgbColorModel.fromObject(data.deleteGradientButtonDisabled!),
        GradientArgbColorModel.fromObject(data.gradientButton!),
        GradientArgbColorModel.fromObject(data.gradientButtonHover!),
        GradientArgbColorModel.fromObject(data.gradientButtonDisabled!),
        ArgbColorModel.fromObject(data.buttonDisabled!),
        GradientArgbColorModel.fromObject(data.buttonActive!),
        ArgbColorModel.fromObject(data.secondaryButton!),
        ArgbColorModel.fromObject(data.secondaryButtonHover!),
        ArgbColorModel.fromObject(data.closeButtonBackground!),
        ArgbColorModel.fromObject(data.closeButtonBackgroundHover!),
        ArgbColorModel.fromObject(data.closeButtonIcon!),
        ArgbColorModel.fromObject(data.overlayBackground!),
        ArgbColorModel.fromObject(data.popupBackground!),
        GradientArgbColorModel.fromObject(data.mainBackground!),
        ArgbColorModel.fromObject(data.sidebarBackground!),
        ArgbColorModel.fromObject(data.inputBackground!),
        ArgbColorModel.fromObject(data.inputBackgroundFocus!),
        ArgbColorModel.fromObject(data.cardBackground!),
        ArgbColorModel.fromObject(data.highlightBackground!),
        ArgbColorModel.fromObject(data.menuBackground!),
        ArgbColorModel.fromObject(data.menuDropdownBackground!),
        ArgbColorModel.fromObject(data.menuDropdownItemHoverBackground!),
        GradientArgbColorModel.fromObject(data.menuBarBackground!),
        ArgbColorModel.fromObject(data.inputBarBackground!),
        ArgbColorModel.fromObject(data.inputBarShadow!),
        GradientArgbColorModel.fromObject(data.groupPictureBackground!),
        GradientArgbColorModel.fromObject(data.avatarGradientBackground!),
        ArgbColorModel.fromObject(data.messageSenderBackground!),
        ArgbColorModel.fromObject(data.messageAdresatorBackground!),
        ArgbColorModel.fromObject(data.messagePreviewBackground!),
        ArgbColorModel.fromObject(data.messageFilePreviewBackground!),
        ArgbColorModel.fromObject(data.messageAvatarBackground!),
        ArgbColorModel.fromObject(data.reactionCounterBackground!),
        ArgbColorModel.fromObject(data.reactionPopupBackground!),
        ArgbColorModel.fromObject(data.reactionPopupItemBackground!),
        ArgbColorModel.fromObject(data.reactionPopupItemHoverBackground!),
        ArgbColorModel.fromObject(data.popupBorder!),
        GradientArgbColorModel.fromObject(data.popupGradientBorder!),
        GradientArgbColorModel.fromObject(data.mainBorder!),
        ArgbColorModel.fromObject(data.inputBorder!),
        ArgbColorModel.fromObject(data.inputBorderFocus!),
        ArgbColorModel.fromObject(data.errorBorder!),
        ArgbColorModel.fromObject(data.listBorder!),
        ArgbColorModel.fromObject(data.replyPreviewBarBorder!),
        ArgbColorModel.fromObject(data.listDivider!),
        ArgbColorModel.fromObject(data.primaryText!),
        ArgbColorModel.fromObject(data.secondaryText!),
        ArgbColorModel.fromObject(data.mutedText!),
        ArgbColorModel.fromObject(data.disabledText!),
        ArgbColorModel.fromObject(data.dangerText!),
        ArgbColorModel.fromObject(data.successText!),
        ArgbColorModel.fromObject(data.buttonText!),
        ArgbColorModel.fromObject(data.headingText!),
        ArgbColorModel.fromObject(data.messageSenderText!),
        ArgbColorModel.fromObject(data.messageAdresatorText!),
        ArgbColorModel.fromObject(data.messagePreviewText!),
        ArgbColorModel.fromObject(data.messageFilePreviewText!),
        ArgbColorModel.fromObject(data.messageFilePreviewIcon!),
        ArgbColorModel.fromObject(data.reactionCounterText!),
        ArgbColorModel.fromObject(data.reactionPopupItemText!),
        ArgbColorModel.fromObject(data.popupText!),
        ArgbColorModel.fromObject(data.inputText!),
        ArgbColorModel.fromObject(data.inputPlaceholder!),
        ArgbColorModel.fromObject(data.fileCountCircleText!),
        ArgbColorModel.fromObject(data.menuActionText!),
        ArgbColorModel.fromObject(data.menuActionDisabledText!),
        ArgbColorModel.fromObject(data.menuDeleteText!),
        ArgbColorModel.fromObject(data.avatarIconColor!),
        ArgbColorModel.fromObject(data.errorBackground!),
        ArgbColorModel.fromObject(data.successBackground!),
        ArgbColorModel.fromObject(data.warningBackground!),
        GradientArgbColorModel.fromObject(data.switchOn!),
        GradientArgbColorModel.fromObject(data.switchOff!),
        ArgbColorModel.fromObject(data.switchThumb!),
        ArgbColorModel.fromObject(data.switchThumbShadow!),
        ArgbColorModel.fromObject(data.scrollbarThumb!),
        ArgbColorModel.fromObject(data.scrollbarThumbHover!),
        ArgbColorModel.fromObject(data.scrollbarTrack!),
        ArgbColorModel.fromObject(data.inputScrollbarTrack!),
        GradientArgbColorModel.fromObject(data.inputScrollbarThumb!),
        GradientArgbColorModel.fromObject(data.inputScrollbarThumbHover!),
        ArgbColorModel.fromObject(data.shadow!),
        ArgbColorModel.fromObject(data.popupShadow!),
        ArgbColorModel.fromObject(data.menuShadow!),
        ArgbColorModel.fromObject(data.menuDropdownShadow!),
        ArgbColorModel.fromObject(data.buttonShadow!),
        ArgbColorModel.fromObject(data.listShadow!),
        ArgbColorModel.fromObject(data.messageShadow!),
        ArgbColorModel.fromObject(data.profilePictureBackground!),
        ArgbColorModel.fromObject(data.fileCountCircleBackground!),
        ArgbColorModel.fromObject(data.replyPreviewBarCloseButton!),
        ArgbColorModel.fromObject(data.replyPreviewBarCloseButtonHover!),
        ArgbColorModel.fromObject(data.messagePlaceholder!),
        ArgbColorModel.fromObject(data.messageStatusIcon!),
        ArgbColorModel.fromObject(data.messageStatusReadIcon!),
        ArgbColorModel.fromObject(data.inputSpinnerDot!),
        ArgbColorModel.fromObject(data.inputSpinnerText!),
        ArgbColorModel.fromObject(data.popupProgressTrack!),
        ArgbColorModel.fromObject(data.popupProgress!),
        ArgbColorModel.fromObject(data.reactionPopupShadow!),
        GradientArgbColorModel.fromObject(data.menuGradientBorder!),
        GradientArgbColorModel.fromObject(data.menuButtonGradientHover!),
        ArgbColorModel.fromObject(data.menuButtonBackground!),
        ArgbColorModel.fromObject(data.menuButtonBackgroundHover!),
        ArgbColorModel.fromObject(data.menuButtonIconHover!),
        ArgbColorModel.fromObject(data.menuActionBackground!),
        ArgbColorModel.fromObject(data.menuActionBackgroundHover!),
        ArgbColorModel.fromObject(data.menuActionIcon!),
        ArgbColorModel.fromObject(data.menuActionIconHover!),
        ArgbColorModel.fromObject(data.menuActionDisabledBackground!),
        ArgbColorModel.fromObject(data.menuActionDisabledIcon!),
        ArgbColorModel.fromObject(data.menuDeleteBackground!),
        ArgbColorModel.fromObject(data.menuDeleteBackgroundHover!),
        ArgbColorModel.fromObject(data.menuDeleteIcon!),
        ArgbColorModel.fromObject(data.menuDeleteIconHover!),
        ArgbColorModel.fromObject(data.listBackground!),
        ArgbColorModel.fromObject(data.listItemHover!),
        ArgbColorModel.fromObject(data.listItemActive!),
        ArgbColorModel.fromObject(data.listItemRing!)
    );
    }  
}