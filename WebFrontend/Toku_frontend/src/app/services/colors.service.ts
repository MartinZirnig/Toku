...
export const buttonBackground = colors.gray[500];
export const buttonHoverBackground = colors.black;
export const textColor = colors.gray[400];
export const placeholderColor = colors.gray[400];
export const textareaBackground = colors.gray[800];
export const textareaFocusBackground = colors.gray[700];
